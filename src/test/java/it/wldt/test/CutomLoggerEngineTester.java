...
public class CutomLoggerEngineTester {

    private static final WldtLogger logger = WldtLoggerProvider.getLogger(CutomLoggerEngineTester.class);
    ...
    public void setUp() throws ModelException, WldtRuntimeException, EventBusException, WldtConfigurationException, WldtEngineException, WldtWorkerException, WldtDigitalTwinStateException {
        ...
        // Set a Custom WLDT Logger
        WldtLoggerProvider.setFactory(new CustomWldtLoggerFactory());
