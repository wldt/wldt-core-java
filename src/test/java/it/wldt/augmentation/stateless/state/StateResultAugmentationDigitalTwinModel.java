...
public class StateResultAugmentationDigitalTwinModel extends DigitalTwinModel {

    private static final WldtLogger logger = WldtLoggerProvider.getLogger(StateResultAugmentationDigitalTwinModel.class);

    private boolean isShadowed = false;

    public StateResultAugmentationDigitalTwinModel() {
    ...
    protected void onPhysicalAssetPropertyVariation(PhysicalAssetPropertyWldtEvent<?> physicalPropertyEventMessage) {
        ...
        try {
            ...
            this.executeAugmentationFunction(RandomStateResultAugmentationFunction.FUNCTION_ID);
