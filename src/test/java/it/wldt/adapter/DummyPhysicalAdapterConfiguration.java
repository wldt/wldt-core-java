...
public class DummyPhysicalAdapterConfiguration {
    ...
    public DummyPhysicalAdapterConfiguration() {
    }

    public DummyPhysicalAdapterConfiguration(String brokerIp, int brokerPort, String username, String password) {
