...
public class StorageManagerTester {
    ...
    private static final WldtLogger logger = WldtLoggerProvider.getLogger(StorageManagerTester.class);
    ...
    @Test
    @Order(1)
    public void testPhysicalAdapterEvents() throws WldtConfigurationException, EventBusException, KernelException, InterruptedException, WldtRuntimeException, StorageException {
    ...
    public void testDigitalTwinStateUpdates() throws WldtConfigurationException, EventBusException, KernelException, InterruptedException, WldtRuntimeException, StorageException {
        ...
        // The total number of DT State Update (according to the current DigitalTwinModel) is equals to the number
    ...
    @Test
    @Order(3)
    public void basicDigitalActionTest() throws WldtConfigurationException, InterruptedException, KernelException, WldtRuntimeException, EventBusException, WldtWorkerException, WldtDigitalTwinStateException, WldtEngineException, StorageException {
    ...
    @Test
    @Order(7)
    public void testDigitalTwinStateNotifications() throws WldtConfigurationException, EventBusException, KernelException, InterruptedException, WldtRuntimeException, StorageException {
