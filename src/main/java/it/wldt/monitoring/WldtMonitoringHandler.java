 ...
 * {@link MonitoringConfiguration}.</p>
 *
 ...
 * manner.</p>
 */
public abstract class WldtMonitoringHandler {
    ...
    /**
     * Called when a metric is emitted by the internal Event Bus component.
     *
     * <p>Typical metric types and names:</p>
     * <ul>
     *   <li>{@link WldtCounter} {@code event_bus.published_events} — total events
     *       published on the bus since DT startup.</li>
     *   <li>{@link WldtCounter} {@code event_bus.dropped_events} — total events
     *       dropped due to queue saturation.</li>
     *   <li>{@link WldtGauge} {@code event_bus.queue_depth} — current number of
     *       pending events in the bus queue.</li>
     * </ul>
     *
     * @param metric the enriched metric emitted by the Event Bus; never null
     */
    public void onEventBusMetric(WldtMetric metric) {}
     ...
     * configured in {@link MonitoringConfiguration#getCustomMetricNamespace()}.</p>
     *
     * <p>Example:</p>
     * <pre>{@code
     * @Override
