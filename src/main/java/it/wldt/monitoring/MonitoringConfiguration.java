...
public final class MonitoringConfiguration {
    ...
    /** Flag controlling whether metrics from the internal Event Bus are monitored. */
    private final boolean eventBusMonitoringEnabled;
    ...
    private MonitoringConfiguration(Builder builder) {
        ...
        this.eventBusMonitoringEnabled       = builder.eventBusMonitoringEnabled;
    ...
    /**
     * Returns {@code true} if monitoring is enabled for the internal
     * Event Bus component.
     *
     * @return {@code true} if Event Bus monitoring is active
     */
    public boolean isEventBusMonitoringEnabled() {
        return eventBusMonitoringEnabled;
    }
    ...
    public String toString() {
        return "MonitoringConfiguration{" +
                ...
                ", eventBus=" + eventBusMonitoringEnabled +
    ...
    /**
     * Fluent builder for {@link MonitoringConfiguration}.
     *
    ...
    public static final class Builder {
        ...
        private boolean eventBusMonitoringEnabled       = false;
        ...
        /**
         * Enables monitoring for the internal Event Bus component.
         * When enabled, metrics such as throughput, queue depth, and dropped
         * events will be processed and dispatched.
         *
         * @return this builder for method chaining
         */
        public Builder withEventBusMonitoring() {
            this.eventBusMonitoringEnabled = true;
            return this;
        }
         ...
         *
         * <p>If not called, defaults to {@link MonitoringConfiguration#DEFAULT_CUSTOM_NAMESPACE}.</p>
         *
        ...
        /**
         * Builds and returns an immutable {@link MonitoringConfiguration} instance
         * from the current builder state.
         *
         * @return a new {@link MonitoringConfiguration} with the configured flags
         */
