...
/**
 * Default implementation of the WldtLogger interface.
 * This logger outputs log messages to the console with a timestamp and log level.
 * It supports various log levels: TRACE, DEBUG, INFO, WARN, and ERROR.
 *
 * @author Marco Picone, Ph.D. - picone.m@gmail.com
 */
public class WldtDefaultLogger implements WldtLogger {
     ...
     */
    public WldtDefaultLogger(Class<?> clazz) {
        this.name = clazz.getSimpleName();
    }

    private void log(String level, String msg) {
        String timestamp = dateFormat.format(new Date());
        System.out.printf("%s [%s] [%s] %s%n", timestamp, level, name, msg);
    }
