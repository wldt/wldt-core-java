...
public class DigitalTwinStateManager {
    ...
    /**
     * Returns the WLDT Event Type to subscribe in order to receive all notification about events generated by the DT
     * @return the WLDT Event Type to subscribe to all events
     */
    public static String getAllEventNotificationWldtEventMessageType() {
        return String.format("%s.%s", DT_STATE_EVENT_BASE_TYPE, NOTIFICATION_STRING);
    }
