...
public class DigitalTwinStateManager {
     ...
     */
    private void startStateTransaction(){
     ...
     */
    private void rollbackTransaction() throws WldtDigitalTwinStateException {

        if(!this.isEditing)
            throw new WldtDigitalTwinStateException("Trying to edit Digital Twin State without start a transaction ! Call edit() and then commit() to apply changes");
     ...
     * @throws WldtDigitalTwinStateException
     */
    private void commitStateTransaction() throws WldtDigitalTwinStateException {

        if(digitalTwinStateTransaction == null)
            throw new WldtDigitalTwinStateException("Trying to commit Digital Twin State Transaction without properly starting it ! Call edit() and then commit() to apply changes");
     ...
     */
    private void notifyDigitalTwinStateUpdate() {
        try {
            ...
            logger.error("notifyDigitalTwinStateUpdate() -> Error Notifying State Listeners ! Error: {}", e.getLocalizedMessage());
        }
    }
